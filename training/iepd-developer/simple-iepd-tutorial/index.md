...
In this tutorial we are going to walk through the creation of a simple IEPD using the [IEPD Lifecycle]({{ site.data.pages.iepd }}/lifecycle/ "IEPD Lifecycle"). These steps include:
...
After you have analyzed and determined your exchange requirements, you proceed to [map and model]({{ site.data.pages.iepd }}/lifecycle/map-and-model/) them for the next step in the IEPD development process.
...
- [IEPD SuperHero Series]({{ site.data.pages.iepd }}/iepd-starter-kit/iepd-series/)
- [NIEM Reusable XML Snippets]({{ site.data.pages.iepd }}/iepd-starter-kit/reusable-xml-snippets/)